            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('teleconseiller.dashboard') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse($orders as $order)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-3 px-4 text-center">
                                            <a href="{{ route('teleconseiller.orders.show', $order->id) }}" class="text-blue-500 hover:text-blue-700 mr-2">
