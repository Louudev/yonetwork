...
Route::middleware(['auth', 'user.status'])->group(function () {
    // Routes protégées pour les téléconseillers actifs
    Route::get('/teleconseiller/dashboard', [TeleconseillerController::class, 'dashboard']);
});
...
// Ajouter les routes de blocage/déblocage
